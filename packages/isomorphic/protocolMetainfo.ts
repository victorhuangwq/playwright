...
export const methodMetainfo = new Map<string, MethodMetainfo>([
  ...
  ['Page.webMCPEnable', { title: 'Enable WebMCP', group: 'configuration', }],
  ['Page.webMCPTools', { title: 'Get WebMCP tools', }],
  ['Page.webMCPExecuteTool', { title: 'Execute WebMCP tool', }],
  ['Page.webMCPToolFormElement', { title: 'Get form element for a WebMCP tool', }],
